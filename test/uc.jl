...
@testset "Frequency constrained UC" begin
    ...
    result_dc_actions = solve_fcuc(fcuc_data, PowerModels.DCPPowerModel, highs, setting = s, multinetwork = true)
    ...
    result_no_dc_actions = solve_fcuc(fcuc_data, PowerModels.DCPPowerModel, highs, setting = s, multinetwork = true)
...
@testset "System split constrained UC" begin
    ...
    s = Dict("conv_losses_mp" => true, "relax_uc_binaries" => false, "uc_reserves" => false, "hvdc_inertia_contribution" => false, "fix_cross_border_flows" => false, "add_split_constraints" => false)
     result_without_split_constraints= solve_spcuc(spcuc_data, PowerModels.DCPPowerModel, juniper, setting = s, multinetwork = true)

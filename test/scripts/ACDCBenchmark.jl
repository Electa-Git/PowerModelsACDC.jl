...
files = [
    pkgdir(PowerModelsACDC, "test", "data", "case5_2grids.m");
    pkgdir(PowerModelsACDC, "test", "data", "case3120sp_acdc.m");
    # pkgdir(PowerModelsACDC, "test", "data", "case5_lcc.m");
    pkgdir(PowerModelsACDC, "test", "data", "case5_b2bdc.m");
    # pkgdir(PowerModelsACDC, "test", "data", "case5_dc.m"; # Don’t use normall)y
    pkgdir(PowerModelsACDC, "test", "data", "case5_dcgrid.m");
    pkgdir(PowerModelsACDC, "test", "data", "case5_dcgrid_b0.m");
    pkgdir(PowerModelsACDC, "test", "data", "case24_3zones_acdc.m");
    pkgdir(PowerModelsACDC, "test", "data", "case39_acdc.m");
    pkgdir(PowerModelsACDC, "test", "data", "case3120sp_acdc.m");
    pkgdir(PowerModelsACDC, "test", "data", "pglib_opf_case588_sdet_acdc.m")
]
...
for file in files
    ...
    resultQC = solve_acdcopf(data, PowerModels.QCRMPowerModel, ipopt; setting=s)

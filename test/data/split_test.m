...
mpc.bus = [
	...
	10	 2	 500.0	 0.0	 0.0	 0.0	 1	    1.00000	    3.59033	 230.0	 1	    1.10000	    0.90000;
];

%% generator data
%	bus	Pg      Qg	Qmax	Qmin	Vg	mBase       status	Pmax	Pmin	pc1 pc2 qlcmin qlcmax qc2min qc2max ramp_agc ramp_10 ramp_30 ramp_q apf
mpc.gen = [
	1	 40.0	 		 30.0	 	30.0	 -30.0	 1.07762	 100.0	 1	 400.0	 0.0; % Gas
	1	 170.0	 		 127.5	 	127.5	 -127.5	 1.07762	 100.0	 1	 400.0	 0.0; % Gas
	3	 324.498	 	 390.0	 	390.0	 -390.0	 1.1	 	 100.0	 1	 520.0	 0.0; % Gas
	4	 0.0	 		-10.802	 	150.0	 -150.0	 1.06414	 100.0	 1	 200.0	 0.0; % Gas
	5	 470.694	 	-165.039	450.0	 -450.0	 1.06907	 100.0	 1	 300.0	 0.0; % Gas

	9	 40.0	 		 30.0	 	30.0	 -30.0	 1.07762	 100.0	 1	 600.0	 0.0; % RES
];

%column_names% gen_id inertia_constant ramp_rate
mpc.inertia_constants = [
	1	10 1; % ramp rate in pu of pmax / hour
	2	10 1; % 
	3	10 1;
	4	10 1;
	5	10 1;
...
mpc.gencost = [
	...
	2	  1000.0	 0.0	 3	   0.000000	  55.000000	   1000.000000;
	2	  1000.0	 0.0	 3	   0.000000	  50.000000	   1000.000000;
	2	  1000.0	 0.0	 3	   0.000000	  12.000000	    100.000000;

	2	  1000.0	 0.0	 3	   0.000000	  10.000000	    100.000000; % grid 2
];
...
4	 5	 0.00297	 0.0297	 0.00674	 400.0	 240.0	 240.0	 0.0	  0.0	 1	 -30.0	 30.0;

9	 10	 0.00297	 0.0297	 0.00674	 600.0	 300.0	 240.0	 0.0	  0.0	 1	 -30.0	 30.0;
4	 9	 0.00304	 0.06	 0.00674	 600	 426	 426	 0.0	  0.0	 1	 -30.0	 30.0;
];
...
mpc.convdc = [
    1       5   1       1       0       0     0 1     0.000713994  0.024989802 1 1 4.99 1 0.000416435  0.012493061 1  525         1.1     0.9     10.1     1       0.66198 1.3943009  0.003085833    0.003085833      0    0   0  0 300 -300 200 -200;
    2      10   2       1       0       0     0 1     0.000713994  0.024989802 1 1 4.99 1 0.000416435  0.012493061 1  525         1.1     0.9     10.1     1       0.66198 1.3943009  0.003085833    0.003085833      0    0   0  0 300 -300 200 -200;
];
...
mpc.load_extra = [
                     1                0.0        10000.0          10000.0       0;
                     2                0.0        10000.0          10000.0       0;
                     3                0.0        10000.0          10000.0       0;
					 4                0.0        10000.0          10000.0       0;
                     5                0.0        10000.0          10000.0       0;
];

...
mpc.convdc = [
1       2   3       1       -60    -40    0 1     0.01  0.01 1 1 0.01 1 0.01   0.01 1  345         1.1     0.9     1.1     1       1.103 0.887  2.885    2.885      0.0050    -58.6274   1.0079   0 100 -100 50 -50;
2       3   3       2       0       0     0 1     0.01  0.01 1 1 0.01 1 0.01   0.01 1  345         1.1     0.9     1.1     1       1.103 0.887  2.885    2.885      0.0070     21.9013   1.0000   0 100 -100 50 -50;
3       5   3       2       35       5    0 1     0.01  0.01 1 1 0.01 1 0.01   0.01 1  345         1.1     0.9     1.1     1       1.103 0.887  2.885    2.885      0.0050     36.1856   0.9978   0 100 -100 50 -50;
];
...
%		1       3       0.073   0   0    100     100     100     0;
 ...
 %%  dc generator data
%column_names%  gen_bus	 pgdcset  vgdc	mBase  gen_status pmax pmin control_type droop_const quadratic_cost linear_cost idle_cost
mpc.gendc = [
	2	0      1.0	    100       1       250   0.0   3 0.05 0.0 0.9 0.0;
];

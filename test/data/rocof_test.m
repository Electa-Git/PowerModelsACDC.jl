...
mpc.gen = [
	...
	11	 40.0	 		 30.0	 	30.0	 -30.0	 1.07762	 100.0	 1	 400.0	 0.0; % RES
	11	 170.0	 		 127.5	 	127.5	 -127.5	 1.07762	 100.0	 1	 400.0	 0.0; % RES
	13	 324.498	 	 390.0	 	390.0	 -390.0	 1.1	 	 100.0	 1	 520.0	 0.0; % Gas
	14	 0.0	 		-10.802	 	150.0	 -150.0	 1.06414	 100.0	 1	 600.0	 0.0; % Gas
	15	 470.694	 	-165.039	450.0	 -450.0	 1.06907	 100.0	 1	 600.0	 0.0; % RES
];
...
%column_names%   line_id zone_fr zone_to
mpc.tie_lines = [
	19 1 3;
	20 1 3;
]
...
mpc.gencost = [
	...
	2	  1000.0	 0.0	 3	   0.000000	  15.000000	    100.000000; % grid 3
	2	  1000.0	 0.0	 3	   0.000000	  10.000000	    100.000000;
	2	 40000.0	 0.0	 3	   0.000000	  5.000000	   1000.000000;
	2	  1000.0	 0.0	 3	   0.000000	  10.000000	    100.000000;
	2	  1000.0	 0.0	 3	   0.000000	  10.000000	    100.000000;
];
...
11	 12	 0.00281	 0.0281	 0.00712	 400.0	 400.0	 400.0	 0.0	  0.0	 1	 -30.0	 30.0; % grid 3
...
5	 15	 0.00108	 0.0108	 0.01852	 426	 426	 426	 0.0	  0.0	 1	 -30.0	 30.0; % AC tielines
5	 15	 0.00297	 0.0297	 0.00674	 426	 426	 426	 0.0	  0.0	 1	 -30.0	 30.0;
];
...
mpc.storage = [
	3	 0.0	 0.0	 20.0	 100.0	 50.0	 50.0	 0.8	 0.9	 50.0	 -0.5	 0.5	 0.0	 0.0	 0.0	 0.0	 1;
	10	 0.0	 0.0	 20.0	 100.0	 50.0	 50.0	 0.8	 0.9	 50.0	 -0.5	 0.5	 0.0	 0.0	 0.0	 0.0	 1;
	15	 0.0	 0.0	 20.0	 100.0	 50.0	 50.0	 0.8	 0.9	 50.0	 -0.5	 0.5	 0.0	 0.0	 0.0	 0.0	 1;
]

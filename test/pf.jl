...
@testset "test ac polar pf" begin
    ...
    #
    #     @test isapprox(result["solution"]["gen"]["2"]["pg"], 1.600063; atol = 2e-3)
    #     @test isapprox(result["solution"]["gen"]["3"]["pg"], 0.0; atol = 2e-3)
    #
    #     @test isapprox(result["solution"]["bus"]["1"]["vm"], 1.10000; atol = 2e-3)
    #     @test isapprox(result["solution"]["bus"]["1"]["va"], 0.00000; atol = 2e-3)
    #     @test isapprox(result["solution"]["bus"]["2"]["vm"], 0.92617; atol = 2e-3)
    #     @test isapprox(result["solution"]["bus"]["3"]["vm"], 0.90000; atol = 2e-3)
    #
...
@testset "test dc pf" begin
    ...
    #     @test isapprox(result["objective"], 0; atol = 1e-2)
    #
    #     @test isapprox(result["solution"]["gen"]["1"]["pg"], 1.54994; atol = 2e-3)
    #
...
#         @test isapprox(result["objective"], 0; atol = 1e-2)
#
#         @test isapprox(result["solution"]["gen"]["1"]["pg"], 12.258; atol = 2e-3)
#         @test isapprox(result["solution"]["gen"]["1"]["qg"], 13.264; atol = 2e-3)
#
#         @test isapprox(result["solution"]["bus"]["1"]["vm"], 1.06; atol = 2e-3)
#         @test isapprox(result["solution"]["bus"]["1"]["va"], 0.00000; atol = 2e-3)
#         @test isapprox(result["solution"]["bus"]["3"]["vm"], 0.987; atol = 2e-3)
...
#
#         @test isapprox(result["solution"]["gen"]["65"]["pg"], 1.419; atol = 2e-3)
#         @test isapprox(result["solution"]["gen"]["65"]["qg"], 11.1026; atol = 2e-3)
#
#
#         @test isapprox(result["solution"]["bus"]["101"]["vm"], 1.035; atol = 2e-3)
#         @test isapprox(result["solution"]["bus"]["205"]["vm"], 0.88996; atol = 2e-3)
#         @test isapprox(result["solution"]["bus"]["301"]["vm"], 1.0202; atol = 2e-3)
#
#         @test isapprox(result["solution"]["convdc"]["2"]["pgrid"], -0.753; atol = 2e-3)
#         @test isapprox(result["solution"]["convdc"]["3"]["pdc"], -1.3671; atol = 2e-3)
#         @test isapprox(result["solution"]["busdc"]["5"]["vm"], 1.0004; atol = 2e-3)
#     end
# end
#
#
...
#         @test isapprox(result["solution"]["gen"]["3"]["pg"], 0.0; atol = 2e-3)
#
#         @test isapprox(result["solution"]["bus"]["1"]["vm"], 1.09999; atol = 2e-3)
#         @test isapprox(result["solution"]["bus"]["2"]["vm"], 0.92616; atol = 2e-3)
#         @test isapprox(result["solution"]["bus"]["3"]["vm"], 0.89999; atol = 2e-3)
#

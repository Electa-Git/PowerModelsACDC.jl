...
function variable_generator_contingency(pm::_PM.AbstractPowerModel; nw::Int=_PM.nw_id_default, bounded::Bool = true, report::Bool=true)
    ...
    report && _PM.sol_component_value(pm, nw, :contingency, :gen_cont, _PM.ids(pm, nw, :zones), δPg)
end
"""
...
function variable_converter_contingency(pm::_PM.AbstractPowerModel; nw::Int=_PM.nw_id_default, bounded::Bool = true, report::Bool=true)
    ...
    report && _PM.sol_component_value(pm, nw, :contingency, :conv_cont_plus, _PM.ids(pm, nw, :zones), δPc_plus)
    report && _PM.sol_component_value(pm, nw, :contingency, :conv_cont_minus, _PM.ids(pm, nw, :zones), δPc_minus)
end
...
function variable_storage_contingency(pm::_PM.AbstractPowerModel; nw::Int=_PM.nw_id_default, bounded::Bool = true, report::Bool=true)
    ...
    report && _PM.sol_component_value(pm, nw, :contingency, :storage_cont, _PM.ids(pm, nw, :zones), δPs)
end
"""
...
function variable_tieline_contingency(pm::_PM.AbstractPowerModel; nw::Int=_PM.nw_id_default, bounded::Bool = true, report::Bool=true)
    ...
    report && _PM.sol_component_value(pm, nw, :contingency_l, :tieline_cont_plus, _PM.ids(pm, nw, :areas), δPl_plus)
    report && _PM.sol_component_value(pm, nw, :contingency_l, :tieline_cont_minus, _PM.ids(pm, nw, :areas), δPl_minus)
end
"""
...
function variable_dcgrid_auxiliary_voltage_magnitude(pm::_PM.AbstractPowerModel; nw::Int=_PM.nw_id_default, bounded::Bool = true, report::Bool=true)
    ...
    report && _PM.sol_component_value(pm, nw, :busdc, :vm_star, _PM.ids(pm, nw, :busdc), vdcm)
end
"""

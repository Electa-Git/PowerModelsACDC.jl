...
```
"""
function constraint_power_balance_ac(pm::_PM.AbstractWModels, n::Int, i::Int, bus_arcs, bus_arcs_pst, bus_arcs_sssc, bus_convs_ac, bus_arcs_sw, bus_gens,bus_ims, bus_storage, bus_loads, bus_gs, bus_bs)
    w   = _PM.var(pm, n, :w, i)
    p    = _PM.var(pm, n, :p)
    q    = _PM.var(pm, n, :q)
...
```
"""
function constraint_power_balance_acdc_ne(pm::_PM.AbstractWModels, n::Int, i::Int, bus_arcs, bus_arcs_ne, bus_arcs_dc, bus_arcs_pst, bus_arcs_sssc, bus_gens, bus_convs_ac, bus_convs_ac_ne, bus_loads, bus_storage, bus_shunts, gs, bs)
    w = _PM.var(pm, n, :w, i)
    p = _PM.var(pm, n, :p)

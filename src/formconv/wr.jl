...
```
"""
function constraint_converter_current(pm::AbstractWRModel, n::Int, i::Int, Umax, Imax)
...
function constraint_converter_current(pm::AbstractWRConicModel, n::Int,  i::Int, Umax, Imax)
    wc = PowerModels.var(pm, n,  :wc_ac, i)
    pconv_ac = PowerModels.var(pm, n,  :pconv_ac, i)
    qconv_ac = PowerModels.var(pm, n,  :qconv_ac, i)
    iconv = PowerModels.var(pm, n,  :iconv_ac, i)
